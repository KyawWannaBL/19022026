...
export default function RealTimeMapView({ city }) {
    ...
    return (_jsx("div", { className: "luxury-card overflow-hidden h-[500px] relative", children: _jsx("div", { ref: mapContainer, className: "absolute inset-0" }) }));
}
