...
export function ShipmentCard({ shipment, onClick, className }) {
    ...
    return (_jsx(motion.div, { initial: { opacity: 0, y: 10 }, animate: { opacity: 1, y: 0 }, transition: springPresets.gentle, whileHover: { y: -4 }, className: "cursor-pointer", onClick: () => onClick?.(shipment.id), children: _jsxs(Card, { className: cn("overflow-hidden border-border bg-card shadow-sm", className), children: [_jsx("div", { className: "h-1 bg-primary/20", children: isPriority && _jsx("div", { className: "h-full bg-primary w-full" }) }), _jsxs(CardContent, { className: "p-4", children: [_jsxs("div", { className: "flex items-start justify-between mb-4", children: [_jsxs("div", { children: [_jsxs("div", { className: "flex items-center space-x-2", children: [_jsx("span", { className: "text-sm font-mono font-bold text-foreground", children: awb }), isPriority && (_jsx(Badge, { variant: "outline", className: "bg-primary/5 text-primary border-primary/20 text-[10px] uppercase", children: "Priority" }))] }), _jsxs("p", { className: "text-xs text-muted-foreground mt-0.5", children: ["Created ", formatDate(shipment.createdAt)] })] }), _jsx(StatusBadge, { status: shipment.status, size: "sm" })] }), _jsxs("div", { className: "flex items-center space-x-3 mb-4", children: [_jsxs("div", { className: "flex flex-col items-center", children: [_jsx("div", { className: "w-2 h-2 rounded-full bg-primary" }), _jsx("div", { className: "w-px h-8 bg-border my-1" }), _jsx("div", { className: "w-2 h-2 rounded-full border-2 border-primary" })] }), _jsxs("div", { className: "flex flex-col space-y-3 flex-1", children: [_jsxs("div", { className: "text-sm", children: [_jsx("span", { className: "font-medium text-foreground block leading-none", children: pickupAddress?.city || pickupAddress?.address || shipment.senderName }), _jsxs("span", { className: "text-xs text-muted-foreground", children: ["Sender: ", pickupAddress?.name || shipment.senderName] })] }), _jsxs("div", { className: "text-sm", children: [_jsx("span", { className: "font-medium text-foreground block leading-none", children: deliveryAddress?.city || deliveryAddress?.address || shipment.destinationTownship }), _jsxs("span", { className: "text-xs text-muted-foreground", children: ["Receiver: ", deliveryAddress?.name || shipment.receiverName] })] })] })] }), _jsxs("div", { className: "grid grid-cols-2 gap-4 pt-4 border-t border-border", children: [_jsxs("div", { className: "flex items-center space-x-2", children: [_jsx(Weight, { className: "w-3.5 h-3.5 text-muted-foreground" }), _jsx("span", { className: "text-xs text-muted-foreground", children: formatWeight(weight) })] }), _jsxs("div", { className: "flex items-center space-x-2 justify-end", children: [_jsx(Calendar, { className: "w-3.5 h-3.5 text-muted-foreground" }), _jsxs("span", { className: "text-xs text-muted-foreground", children: ["ETA: ", estimatedDelivery ? new Date(estimatedDelivery).toLocaleDateString() : 'TBD'] })] })] })] })] }) }));
}
