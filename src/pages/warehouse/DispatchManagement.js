...
const DispatchManagement = () => {
    ...
    const filteredAvailable = useMemo(() => {
        if (!destination)
            return [];
        return MOCK_AVAILABLE_SHIPMENTS.filter(s => s.destinationTownship === destination &&
