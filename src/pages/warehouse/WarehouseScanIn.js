...
export default function WarehouseScanIn() {
    ...
    const loadTodayStats = async () => {
        ...
        try {
            ...
            const todayOperations = operations.filter(op => new Date(op.created_at).toDateString() === today &&
    ...
    const renderScanResult = (result) => (_jsx(Card, { className: `${result.success ? 'border-green-200 bg-green-50' : 'border-red-200 bg-red-50'}`, children: _jsx(CardContent, { className: "p-4", children: _jsxs("div", { className: "flex items-start justify-between", children: [_jsxs("div", { className: "flex items-center space-x-3", children: [result.success ? (_jsx(CheckCircle, { className: "h-5 w-5 text-green-600" })) : (_jsx(XCircle, { className: "h-5 w-5 text-red-600" })), _jsxs("div", { children: [_jsx("p", { className: "font-medium", children: result.trackingNumber }), _jsx("p", { className: "text-sm text-gray-600", children: result.message }), result.success && result.parcel && (_jsxs("div", { className: "mt-2 text-sm space-y-1", children: [_jsxs("div", { className: "flex items-center space-x-2", children: [_jsx(User, { className: "h-4 w-4 text-gray-400" }), _jsxs("span", { children: [_jsxs("strong", { children: [t('common.sender'), ":"] }), " ", result.parcel.sender_name] })] }), _jsxs("div", { className: "flex items-center space-x-2", children: [_jsx(User, { className: "h-4 w-4 text-gray-400" }), _jsxs("span", { children: [_jsxs("strong", { children: [t('common.receiver'), ":"] }), " ", result.parcel.receiver_name] })] }), _jsxs("div", { className: "flex items-center space-x-2", children: [_jsx(Package, { className: "h-4 w-4 text-gray-400" }), _jsxs("span", { children: [_jsxs("strong", { children: [t('common.type'), ":"] }), " ", result.parcel.package_type] })] }), result.parcel.cod_amount > 0 && (_jsx("div", { className: "flex items-center space-x-2", children: _jsxs("span", { className: "text-orange-600 font-medium", children: ["COD: ", result.parcel.cod_amount.toLocaleString(), " MMK"] }) }))] }))] })] }), _jsxs("div", { className: "text-right", children: [_jsx(Badge, { variant: result.success ? 'default' : 'destructive', children: result.success ? t('warehouse.received') : t('warehouse.failed') }), _jsx("p", { className: "text-xs text-gray-500 mt-1", children: result.timestamp.toLocaleTimeString() })] })] }) }) }, result.id));
