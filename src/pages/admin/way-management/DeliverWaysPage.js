...
const DeliverWaysPage = () => {
    ...
    const filteredDeliveryWays = deliveryWays.filter(way => way.tracking_number.toLowerCase().includes(searchQuery.toLowerCase()) ||
