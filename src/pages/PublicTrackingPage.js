...
export default function PublicTrackingPage() {
    ...
    const getDemoStatus = (trackingNumber) => {
    ...
    const getDemoDestination = (trackingNumber) => {
        const num = parseInt(trackingNumber.replace(/\D/g, '')) || 0;
    ...
    return (_jsxs("div", { className: "min-h-screen bg-background", children: [_jsxs("section", { className: "relative bg-gradient-to-br from-navy-900 via-navy-800 to-navy-700 text-white overflow-hidden", children: [_jsx("div", { className: "absolute inset-0 bg-gradient-to-b from-navy-900/50 via-transparent to-navy-900/70" }), _jsx("img", { src: IMAGES.TRACKING_DASHBOARD_1, alt: "Package Tracking", className: "absolute inset-0 w-full h-full object-cover opacity-20" }), _jsx("div", { className: "relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20", children: _jsxs("div", { className: "text-center", children: [_jsxs("h1", { className: "text-4xl lg:text-6xl font-bold leading-tight mb-6", children: ["Track Your ", _jsx("span", { className: "text-gold", children: "Package" })] }), _jsx("p", { className: "text-xl lg:text-2xl text-navy-200 max-w-3xl mx-auto", children: "Get real-time updates on your shipment status and delivery progress." })] }) })] }), _jsx("section", { className: "py-20 bg-white", children: _jsxs("div", { className: "max-w-4xl mx-auto px-4 sm:px-6 lg:px-8", children: [_jsxs("div", { className: "text-center mb-12", children: [_jsx("h2", { className: "text-3xl font-bold text-gray-900 mb-4", children: "Enter Your Tracking Number" }), _jsx("p", { className: "text-lg text-gray-600", children: "Enter your tracking ID (e.g., BE-12345) to get the latest status of your shipment." })] }), _jsx(Card, { className: "mb-8 shadow-lg border-0", children: _jsx(CardContent, { className: "p-8", children: _jsxs("div", { className: "flex flex-col sm:flex-row gap-4", children: [_jsx("div", { className: "flex-1", children: _jsx(Input, { type: "text", placeholder: "Enter tracking number (e.g., BE-12345)", value: trackingNumber, onChange: (e) => setTrackingNumber(e.target.value), onKeyPress: handleKeyPress, className: "text-lg py-6 border-2 border-gray-300 focus:border-gold focus:ring-gold" }) }), _jsx(Button, { onClick: handleTrack, disabled: loading, size: "lg", className: "bg-gold hover:bg-gold/90 text-navy-900 font-bold px-8 py-6", children: loading ? (_jsxs(_Fragment, { children: [_jsx(Loader2, { className: "w-5 h-5 mr-2 animate-spin" }), "Tracking..."] })) : (_jsxs(_Fragment, { children: [_jsx(Search, { className: "w-5 h-5 mr-2" }), "Track Package"] })) })] }) }) }), error && (_jsxs(Alert, { className: "mb-8 border-red-200 bg-red-50", children: [_jsx(AlertCircle, { className: "h-4 w-4 text-red-600" }), _jsx(AlertDescription, { className: "text-red-800", children: error })] })), trackingResult && (_jsxs(Card, { className: "shadow-xl border-0", children: [_jsxs(CardHeader, { className: "bg-navy-900 text-white", children: [_jsxs("div", { className: "flex items-center justify-between", children: [_jsx(CardTitle, { className: "text-2xl", children: "Tracking Details" }), _jsx(Badge, { className: `${getStatusColor(trackingResult.status)} border`, children: _jsxs("div", { className: "flex items-center gap-2", children: [getStatusIcon(trackingResult.status), trackingResult.status] }) })] }), _jsxs("p", { className: "text-navy-200", children: ["Tracking ID: ", _jsx("span", { className: "font-bold text-gold", children: trackingResult.tracking_number })] })] }), _jsxs(CardContent, { className: "p-8", children: [_jsxs("div", { className: "grid md:grid-cols-2 gap-8", children: [_jsxs("div", { className: "space-y-6", children: [_jsx("h3", { className: "text-xl font-bold text-gray-900 border-b pb-2", children: "Shipment Information" }), _jsxs("div", { className: "space-y-4", children: [_jsxs("div", { className: "flex items-start gap-3", children: [_jsx(MapPin, { className: "w-5 h-5 text-gold mt-1 flex-shrink-0" }), _jsxs("div", { children: [_jsx("p", { className: "font-medium text-gray-900", children: "Route" }), _jsxs("p", { className: "text-gray-600", children: ["From: ", _jsx("span", { className: "font-medium", children: trackingResult.from_city })] }), _jsxs("p", { className: "text-gray-600", children: ["To: ", _jsx("span", { className: "font-medium", children: trackingResult.to_city })] })] })] }), _jsxs("div", { className: "flex items-start gap-3", children: [_jsx(Package, { className: "w-5 h-5 text-gold mt-1 flex-shrink-0" }), _jsxs("div", { children: [_jsx("p", { className: "font-medium text-gray-900", children: "Sender" }), _jsx("p", { className: "text-gray-600", children: trackingResult.sender_name })] })] }), _jsxs("div", { className: "flex items-start gap-3", children: [_jsx(Package, { className: "w-5 h-5 text-gold mt-1 flex-shrink-0" }), _jsxs("div", { children: [_jsx("p", { className: "font-medium text-gray-900", children: "Receiver" }), _jsx("p", { className: "text-gray-600", children: trackingResult.receiver_name })] })] })] })] }), _jsxs("div", { className: "space-y-6", children: [_jsx("h3", { className: "text-xl font-bold text-gray-900 border-b pb-2", children: "Timeline" }), _jsxs("div", { className: "space-y-4", children: [_jsxs("div", { className: "flex items-start gap-3", children: [_jsx(Clock, { className: "w-5 h-5 text-gold mt-1 flex-shrink-0" }), _jsxs("div", { children: [_jsx("p", { className: "font-medium text-gray-900", children: "Created" }), _jsx("p", { className: "text-gray-600", children: new Date(trackingResult.created_at).toLocaleDateString('en-US', {
                                                                                        year: 'numeric',
                                                                                        month: 'long',
                                                                                        day: 'numeric',
                                                                                        hour: '2-digit',
