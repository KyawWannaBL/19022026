...
export default function GetQuotePage() {
    ...
    const getDeliveryTime = (serviceType, region, destination) => {
        if (serviceType === 'domestic') {
            if (region === 'yangon')
                return '1-2 Days';
            return '2-3 Days';
