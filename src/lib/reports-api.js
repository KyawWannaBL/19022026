...
export class ReportsAPI {
    ...
    static async generateKPIReport(filters = {}) {
        try {
    ...
    static async generateDeliveryReport(filters = {}) {
        try {
    ...
    static async generateMerchantReport(merchantId, filters = {}) {
        try {
            const { data, error } = await supabase
    ...
    static async generateRiderReport(riderId, filters = {}) {
        try {
            const { data, error } = await supabase
    ...
    static async generateWarehouseReport(warehouseId, filters = {}) {
        try {
            const { data, error } = await supabase
    ...
    static async exportToCSV(reportData, filename) {
        try {
    ...
    // Get Saved Reports
    static async getSavedReports(filters = {}) {
        try {
            let query = supabase
                .from('operational_reports')
                .select('*')
