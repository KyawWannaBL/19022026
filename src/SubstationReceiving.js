...
const SubstationReceiving = () => {
    ...
    const filteredShipments = useMemo(() => {
        ...
        return shipmentsData.shipments.filter(s => {
            ...
            const isRelevant = s.destination_branch_id === user?.branch_id || s.current_location === user?.branch_id;
