...
export default function WarehouseOperations() {
    ...
    const filteredInventory = useMemo(() => {
        return inventory.filter(item => item.awb?.toLowerCase().includes(searchQuery.toLowerCase()) ||
