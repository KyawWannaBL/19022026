...
```
const OrderDetailsScreen: React.FC<{ route: { params: { order: Order } } } >= ( { route } ) => { // ... screen logic
```
...
![chart](https://static-us-img.skywork.ai/prod/nexus/1770143520/cropped_image_3_1770143520141030560.jpg)
